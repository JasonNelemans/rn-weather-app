...
If confusion at line 7 of WeatherInfo component, remember this:   
  const testing = [{ 1: 'one', 2: 'two', 3: 'three' }];
  const [desctructered] = testing;

console.log('destructered: ', desctructered); // Output: { 1: 'one', 2: 'two', 3: 'three' }
